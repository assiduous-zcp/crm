...
/**
 * 添加与更新记录
 * @param saveUrl   添加记录后端url地址
 * @param updateUrl 更新记录后端url地址
 * @param dlgId     对话框id
 * @param search    多条件搜索方法名
 * @param clearData 清除表单数据方法名
 */
function saveOrUpdateRecode(saveUrl,updateUrl,formId,dlgId,search,clearData) {
    var url = saveUrl;
