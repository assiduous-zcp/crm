...
<body style="margin: 1px">
       ...
       url="${ctx}/sale_chance/list?state=1" fit="true" toolbar="#tb" singleSelect="true">
        <thead>
            <tr>
                ...
                <th field="cgjl" width="50" align="center">成功 几率</th>
    ...
    <div id="dlg" class="easyui-dialog" style="width:800px;height:500px" resizable="true"
            ...
            <form id="fm">
                <table cellspacing="8px">
                    ...
                    <tr>
                        ...
                        <td> </td>
                        <td>指派时间： </td>
                        <td><input type="text" id="assignTime" name="assignTime" readonly="readonly" value="${saleChance.assignTime?string("yyyy-MM-ddHH:mm:ss")}" /></td>
                    </tr>-->
                </table>
            </form>
        </div>
        ...
        <#--开发计划详情记录-->
        <table id="dg02" class="easyui-edatagrid" title="开发计划项"<#-- style="width:700px;height:250px"-->
               <#--toolbar="#toolbar" idField="id"--> pagination="true"
               rownumbers="true" fitColumns="true" singleSelect="true"><thead>
            <tr>
                <th field="id" width="50">编号</th>
                <th field="planDate" name="planDate" width="50"
                    editor="{type:'datebox',options:{required:true,editable:false}}">日期</th>
                <th field="planItem" width="100"
                    editor="{type:'validatebox',options:{required:true}}">计划内容</th>
                <th field="exeAffect" width="100"
                    editor="{type:'validatebox',options:{required:true}}">执行效果</th>
            </tr>
            </thead>
        </table>
        ...
        <div id="toolbar">
                ...
                <a href="javascript:delCusDevPlan()" class="easyui-linkbutton"
                   iconCls="icon-remove" plain="true" >删除计划</a>
