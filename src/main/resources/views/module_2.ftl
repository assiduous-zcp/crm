...
<body style="margin: 1px">
    ...
    <div id="tb">
        ...
        <div>
            菜单名称： <input type="text" id="s_moduleName" size="20" onkeydown="if(event.keyCode==13) searchModules()"/>
            权限码： <input type="text" id="s_code" size="20" onkeydown="if(event.keyCode==13) searchModules()"/>
    ...
    <div id="dlg" class="easyui-dialog" style="width:700px;height:400px;padding: 10px 20px"
        ...
        <form id="fm" method="post">
            <table cellspacing="8px">
                ...
                <tr>
                    <td>url：</td>
                    <td><input type="text" id="url" name="url"  class="easyui-validatebox" required="true"/><font color="red">*</font></td>
                    <td></td>
                    <td>排序：</td>
                ...
                <tr>
                    ...
                    <#--查询所有有效的一级菜单-->
                    <td>
                        <input id="parentId" name="parentId" class="easyui-combobox"
                               valueField="id" textField="text" url="${ctx}/module/queryAllModulesByGrade?grade=0"
